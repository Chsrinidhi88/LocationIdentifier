...
function draw() {
  ...
  if (gameState === "end" || gameState === "gph") {
    ...
    text("Enter No of Lacations that are Cold inside the Boundary", 50, 120);
    text(
      "Enter No of Lacations that are Cold and outside the Boundary",
      50,
      160
    );
  }
...
function check(col, i, j) {
  ...
  if (
    //If the temp is < 20 it is cold. If it is >= 20, it is hot.
    win[0][0] == 1 &&
    win[0][1] == 1 &&
    win[0][2] == 1 &&
    win[0][3] == 1 &&
